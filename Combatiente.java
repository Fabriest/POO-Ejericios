abstract class Combatiente {
    ...
    public Combatiente(String nombre, int vidaMaxima, int poderAtaque) {
    ...
    public void atacar(Combatiente objetivo) throws ObjetivoInvalidoException, CombatienteMuertoException {
