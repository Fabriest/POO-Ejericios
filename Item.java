abstract class Item {
    ...
    public Item(String nombre, int cantidad, boolean consumible, int poder) {
    ...
    public void usar(Combatiente usuario, Combatiente objetivo) throws ItemAgotadoException, ObjetivoInvalidoException {
